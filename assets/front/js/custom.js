    ...
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        $this.find(".alert-danger ul").html("");
                        for (var error in data.errors) {
                            $(".signin-form .alert-danger p").html(
                                data.errors[error]
                            );
                        }
                    } else {
                ...
                success: function (data) {
                    ...
                    $(".all-comment").prepend(
                        "<li>" +
                            ...
                            '<div class="links">' +
                            '<a href="javascript:;" class="comment-link reply mr-2"><i class="fas fa-reply "></i>' +
                            langg.lang107 +
                            "</a>" +
                            '<a href="javascript:;" class="comment-link edit mr-2"><i class="fas fa-edit "></i>' +
                            langg.lang111 +
                            "</a>" +
                            '<a href="javascript:;" data-href="' +
                            data[5] +
                            '" class="comment-link comment-delete mr-2">' +
                    ...
                    $("#comment-form button.submit-btn").prop(
                        "disabled",
                        false
                    );
                },
                ...
                success: function (data) {
                    ...
                    $this.before(
                        '<div class="single-comment replay-review">' +
                            ...
                            '<a href="javascript:;" data-href="' +
                            data[4] +
                            '" class="comment-link reply-delete mr-2">' +
                            '<i class="fas fa-trash"></i>' +
                            langg.lang112 +
                            "</a>" +
                            "</div>" +
        ...
        $(document).on("submit", ".update", function (e) {
            ...
            var text = $(this)
                .parent()
                .prev()
                .find(".right-area .comment-body p");
            var $this = $(this).parent();
            btn.prop("disabled", true);
            $.ajax({
                method: "POST",
