...
// **************** ADD TO CART *******************
    ...
    public function add($item, $id, $size,$color, $keys, $values) {
        $size_cost = 0;
        $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => $keys, 'values' => $values,'item_price' => $item->price,'referral_bonus'=> $item->referral_bonus,'referral_user_bonus'=>$item->referral_user_bonus,'sku'=>$item->sku,'is_referral_bonus'=>$item->is_referral_bonus];
...
// **************** ADDING QUANTITY *******************
    ...
    public function adding($item, $id, $size_qty) {
        ...
        $storedItem = ['qty' => 0,'size_key' => 0, 'size_qty' =>  $item->size_qty,'size_price' => $item->size_price, 'size' => $item->size, 'color' => $item->color, 'stock' => $item->stock, 'price' => $item->price, 'item' => $item, 'license' => '', 'dp' => '0','keys' => '', 'values' => '','item_price' => $item->price,'referral_bonus'=> $item->referral_bonus,'referral_user_bonus'=>$item->referral_user_bonus,'sku'=>$item->sku,'is_referral_bonus'=>$item->is_referral_bonus];
        if ($this->items) {
