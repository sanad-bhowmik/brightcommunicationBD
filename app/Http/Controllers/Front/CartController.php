...
class CartController extends Controller
{
   ...
   public function addcart($id)
    ...
    public function addnumcart()
    {
        ...
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes','referral_bonus','referral_user_bonus','sku','is_referral_bonus']);
    ...
    public function referralCodeCheck()
    {
        ...
        foreach ($cart->items as $item) {
           ...
           $discount += (float) $item['qty'] * (float) $item['referral_user_bonus'];
        }
        $total = $total - $_GET['shipping_cost'];
