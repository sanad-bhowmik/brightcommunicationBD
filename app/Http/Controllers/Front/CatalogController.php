...
class CatalogController extends Controller
{
    ...
    public function brand(Request $request, $brand = null)
    {
        ...
        $prods = $prods->where('brand_id', $brand_id)->where('status', 1)->get();
        $prods = (new Collection(Product::filterProducts($prods)))->paginate(18);
        //  dd($prods);
    ...
    public function product($slug)
    {
        ...
        return view('front.product_phones', compact('productt', 'curr', 'vendors'));
    }
    ...
    public function productSearch(Request $request)
    {
        ...
        $data = Product::where('name', 'LIKE', '%' . $input . '%')
