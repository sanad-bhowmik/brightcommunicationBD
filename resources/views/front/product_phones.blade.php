              ...
              <div class="product-info">
                ...
                <div class="info-meta-3">
                  <ul class="meta-list">
                    ...
                    @endif
                    <li class="compare">
                      <a href="javascript:;" class="add-to-compare" data-href="{{ route('product.compare.add',$productt->id) }}"><i class="icofont-exchange"></i></a>
                    </li>
                  </ul>
                </div>
                ...
                <div id="tabs-3" class="tab-content-area" style="font-weight: 900;">
                  <div class="heading-area">
                    ...
                    <div class="reating-area">
                      <div class="stars"><span id="star-rating">{{App\Models\Rating::rating($productt->id)}}</span> <i class="fas fa-star"></i></div>
                    </div>
                  </div>
                  <div id="replay-area">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <br>
                        <h5 class="text-center"><a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg" class="btn login-btn mr-1">{{ $langg->lang101 }}</a> {{ $langg->lang102 }}</h5>
                        <br>
                      </div>
                    </div>
                    @endif
      ...
      <div class="col-lg-12 remove-padding">
        <div class="img">
          <a class="banner-effect" href="#">
            <img src="{{asset('assets/images/galleries/'.$gal->photo)}}" title="" style="display: inline;">
          </a>
        </div>
      </div>
                ...
                <div class="contact-form">
                  <form id="emailreply">
                    ...
                    <ul>
                      ...
                      <li>
                        <input type="text" class="input-field" readonly="" placeholder="Send To {{ $productt->user->shop_name }}" readonly="">
                      </li>
