          ...
          <div class="user-profile-info-area">
            <ul class="links">
             ...
             <!--  <li class="{{ $link == route('user-deposit-index') ? 'active':'' }}">
              ...
              <!--<li class="{{ $link == route('user-bw-index') ? 'active':'' }}">-->
              <!--      <a href="{{route('user-bw-index')}}">Balance Withdraw </a>-->
              <!--  </li>-->
              <!--  <li class="{{ $link == route('user-referral-code') ? 'active':'' }}">-->
              <!--      <a href="{{ route('user-referral-code') }}">Referral Code</a>-->
              <!--  </li>-->
