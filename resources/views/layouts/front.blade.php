...
<head>
    ...
    @else
        ...
        <link rel="stylesheet" href="{{asset('assets/front/css/dasstyle.css')}}">
    @endif
                    ...
                    <div class="content">
                            ...
                            <div class="list">
                                <ul>
                                    @if(!Auth::guard('web')->check())
                                        <li class="login" style="display: flex;">
                                            <a href="{{ route('user.login') }}" class="sign-log">
                                                <div class="links">
                                                    <span class="sign-in">{{ $langg->lang12 }}</span> | <span>
                                                        <!-- signup -->
                                                </div>
                                            </a>
                        ...
                        <div class="right-content">
                            <div class="list">
                                <ul>
                                    <li>
                                        <a href="https://www.instagram.com/bright_communicationbd" class="twitter"
                                            target="_blank"
                                            style="font-size: 20px;width: 38px;height: 38px;display: inline-block;line-height: 38px;margin: 0px 3px;color: #bac9e6;background: none;">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/brightcommunicationbd" class="facebook"
                                            target="_blank"
                                            style="font-size: 20px;width: 38px;height: 38px;display: inline-block;line-height: 38px;margin: 0px 3px;color: #bac9e6;background: none;">
                                    ...
                                    <li>
                                        <a href="https://www.youtube.com/@brightcommunicationbd" class="twitter"
                                            target="_blank"
                                            style="font-size: 20px;width: 38px;height: 38px;display: inline-block;line-height: 38px;margin: 0px 3px;color: #bac9e6;background: none;">
                                    ...
                                    <!--<li>-->
                                    <!--    <a href="tel:01897608888" class="call-center"-->
                                    <!--        style="font-size: 20px;width: 38px;height: 38px;display: inline-block;line-height: 38px;margin: 0px 3px;color: #bac9e6;background: none;">-->
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-8 col-sm-12 remove-padding order-last order-sm-2 order-md-2">
                    <div class="search-box-wrapper d-none">
                ...
                <div class="col-lg-2 col-sm-6 col-7 remove-padding order-lg-last">
                    <div class="helpful-links">
                        <ul class="helpful-links-inner">
                            ...
                            <li>
                                <div class="icon">
                                    <a class="search-icon" href="#"><i class="icofont-search-1"></i></a>
                                    <form class="search-form" action="">
                                        <div>
                                            <span class="close-btn">X</span>
                                            <input type="text" class="search-box" name="product_model"
                                                id="product_model" placeholder="Search by product title.." autofocus
                            ...
                            <li style="margin-right: -14px;">
                                <a href="https://www.instagram.com/bright_communicationbd" class="instagram"
                                    target="_blank"
                                    style="font-size: 20px; width: 38px; height: 38px; display: inline-block; line-height: 38px; margin: 0px 3px; color: #bac9e6; background: none; text-align: center; border-radius: 50%;">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="https://www.youtube.com/@brightcommunicationbd" class="youtube" target="_blank"
                                    style="font-size: 20px; width: 38px; height: 38px; display: inline-block; line-height: 38px; margin: 0px 3px; color: #bac9e6; background: none; text-align: center; border-radius: 50%;">
                                    <i class="fab fa-youtube"></i>
                                </a>
                            </li>
                ...
                <div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
                    <nav hidden>
                        ...
                        <ul class="menu">
                            ...
                            @endforeach
                            <li><a href="{{ route('front.category', 'phones') }}">Phones</a></li>
                            <li class="dropdown">
                                <a href="#">Brands <i class="fa fa-angle-down arrow-down"></i></a>
                                <ul class="dropdown-menu">
                                    @foreach(DB::table('brands')->where('status', 1)->select('id', 'brand_name')->get() as $brand)
                                        @if (isset($brand->id))
                                            <li style="font-weight: 400;">
                                                <a
                                                    href="{{ route('front.brand', ['brand' => $brand->id]) }}">{{ $brand->brand_name }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                </ul>
                            ...
                            <!--<li><a href="{{ route('front.category', 'accessories') }}">Accessories</a></li>-->
                            @if($gs->is_contact == 1)
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-widget">
                        ...
                        <p style="font-size: 15px;color: #bac9e6;margin-top: 19px;">
                            <span>
                                For assistance
                            </span>

                            <br> Call Us :
                            <a href="tel:01897608888" style="color: #bac9e6; text-decoration: none;">
                                <i class="fas fa-phone-alt"></i>01897608888
                            </a>
                        </p>
                    </div>
                </div>
                            ...
                            <div class="login-area">
                                ...
                                <div class="login-form signin-form">
                                    ...
                                    <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                        ...
                                        @if(
                                                App\Models\Socialsetting::find(1)->f_check == 1 ||
