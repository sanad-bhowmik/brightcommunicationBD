								...
								<div class="icon">
									...
									<form class="search-form" action="">
										<div>
											...
											<input type="text" class="search-box" name="product_model" id="product_model" placeholder="Search by product title.." autofocus autocomplete="off" required>
						...
						<ul class="menu">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
                                     @foreach(DB::table('brands')->select('id', 'brand_name')->get() as $brand)
                                         @if (isset($brand->id))
                                             <li style="font-weight: 400;"><a href="{{ route('front.brand', ['brand' => $brand->id]) }}">{{ $brand->brand_name }}</a></li>
                                         @endif
                                     @endforeach
                                 </ul>
									</li>
