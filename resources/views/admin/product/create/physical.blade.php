						...
						<form id="geniusform" action="{{route('admin-prod-store')}}" method="POST" enctype="multipart/form-data">
								...
								<div class="col-lg-7">
									<div class="row">
										<div class="panel panel-body">
											<div class="span4 cropme text-center" id="landscape" style="width: 309px; height: 640px; border: 1px dashed black;">
											</div>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<ul class="list">
										<li>
											<input class="checkclick1" name="referral_bonus_check" type="checkbox" id="referral_bonus_check" value="1">
											<label for="referral_bonus_check">{{ __('Allow Product For Bonus') }}</label>
										</li>
									</ul>
								</div>
							</div>
										...
										<div class="featured-keyword-area">
											<div class="feature-tag-top-filds" id="bonus-section">
												<div class="feature-area">
													...
													<div class="row">
														<div class="col-lg-6">
															Referral Bonus:<input type="number" name="referral_bonus" class="input-field" placeholder="{{ __('Enter Referral Bonus Amount') }}" min="0">
														</div>

														<div class="col-lg-6">
															Referral User Bonus:<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Bonus Amount') }}" min="0" />
														</div>
													</div>
												</div>
											</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="nic-edit-p" name="specification"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="nic-edit-p" name="warranty"></textarea>
									</div>
								</div>
							</div>
