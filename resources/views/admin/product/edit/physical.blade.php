 ...
 -->
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<ul class="list">
										<li>
											<input class="checkclick1" name="referral_bonus_check" type="checkbox" id="referral_bonus_check" value="1" {{ $data->is_referral_bonus>0 ? "checked":"" }}>
											<label for="referral_bonus_check">{{ __('Allow Referral Bonus') }}</label>
										</li>
									</ul>
								</div>
							</div>

							<div class="{{ $data->is_referral_bonus>0 ? "":"showbox" }}">
								<div class="row">
									<div class="col-lg-4">
										<div class="left-area">
									...
									<div class="col-lg-7">
										<div class="featured-keyword-area">
											<div class="feature-tag-top-filds" id="bonus-section">
												@if($data->is_referral_bonus>0)

												<div class="feature-area">

													<div class="row">
														<div class="col-lg-6">
															Referral Bonus: <input type="number" name="referral_bonus" class="input-field" placeholder="{{ __('Enter Referral Bonus') }}" min="0" value="{{ $data->referral_bonus }}" required="">
														</div>

														<div class="col-lg-6">
															Referral User Bonus:<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Bonus') }}" min="0" value="{{ $data->referral_user_bonus}}" required="">
														</div>
													</div>
												</div>
												...
												<div class="feature-area">
													<span class="remove bonus-remove"><i class="fas fa-times"></i></span>
													<div class="row">
														<div class="col-lg-6">
															<input type="number" name="referral_bonus" class="input-field" placeholder="{{ __('Enter Referral Bonus') }}" min="0" value="0" required="">
														</div>

														<div class="col-lg-6">
															<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Bonus') }}" min="0" value="0" required="">
														</div>
													</div>
												</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="nic-edit-p" name="specification">{{$data->specification}}</textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="nic-edit-p" name="warranty">{{$data->warranty}}</textarea>
									</div>
								</div>
							</div>
				...
				if (data[0] == 0) {
					...
					for (var k in arr) {
						$('.selected-image .row').append('<div class="col-sm-6">' +
							...
							'</span>' +
							'<a href="' + '{{asset("assets/images/galleries").'/'}}' + arr[k]['photo'] + '" target="_blank">' +'<img src="' + '{{asset("assets/images/galleries").'/'}}' + arr[k]['photo'] + '" alt="gallery image">' +
							'</a>' +
							'</div>' +
							'</div>');
					}
