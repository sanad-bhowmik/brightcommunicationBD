  ...
  @endif
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    <h5 class="title">Total Bonus</h5>
                    <span class="number">{{$totalBonus->total}}</span>
                    <a href="{{ route('admin-trans-index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg4">
                <div class="left">
                    <h5 class="title">Total Withdraw</h5>
                    <span class="number">{{$totalBonusWithDraw->total}}</span>
                    <a href="{{ route('admin-withdraw-index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-bill"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    <h5 class="title">Total Remaining</h5>
                    <span class="number">{{ $remainingBonus }}</span>
                    <a href="{{ route('admin-trans-index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
