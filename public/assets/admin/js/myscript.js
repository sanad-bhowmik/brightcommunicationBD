(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".edit", function () {
            ...
            $("#modal1")
                .find(".modal-title")
                .html(alang.edit + " " + $("#headerdata").val());
            $("#modal1 .modal-content .modal-body")
                .html("")
                .load(
                    $(this).attr("data-href"),
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        $(
                            "#modal1 .modal-content .modal-body .alert-danger"
                        ).focus();
                        $("button.addProductSubmit-btn").prop(
                            "disabled",
                            false
                        );
                        $(
                            "#Dasformdata input , #Dasformdata select , #Dasformdata textarea"
                        )
                            .eq(1)
                            .focus();
                    } else {
                        ...
                        $(
                            "#modal1,#modal2,#verify-modal,#ad-subscription-modal"
                        ).modal("hide");
                    }
                    enablekey();
                },
        ...
        if ($(".attr-checkbox").length > 0) {
            $(".attr-checkbox").each(function () {
                ...
                if ($(this).prop("checked") == true) {
                    if (
                        $("#" + $(this).attr("id") + "_price").val().length > 0
                    ) {
