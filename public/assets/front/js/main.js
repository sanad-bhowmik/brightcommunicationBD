...
$(".categories_menu_inner > ul > li.dropdown_list .link-area > a").each(function(){
    $(this).html('<i class="fas fa-plus"></i>');
     ...
     /*------addClass/removeClass categories-------*/
      ...
      /* new by das */
        ...
        /*categories slideToggle*/
           ...
           /*------addClass/removeClass categories-------*/
           $(".categories_links  > ul > li").on("mouseover", function() {
               $(this).find('.my-link-area a').toggleClass('open').parent().parent().find('.my_categories_mega_menu, my_categorie_sub').addClass('open');
               $(this).siblings().find('.my_categories_mega_menu, .my_categorie_sub').removeClass('open');
           });
     ...
     $(document).on('mouseover', function(e) 
     {
         var container = $(".categories_links , .my_categories_mega_menu");
   
         // if the target of the click isn't the container nor a descendant of the container
         if (!container.is(e.target) && container.has(e.target).length === 0) 
         {
          
           $('.my_categories_mega_menu, .my_categorie_sub').removeClass('open');
            $(".my_categories_mega_menu").removeClass('open');
            $(".my_categories_title").removeClass('active');
         }
        ...
        if(w <= 991)
           ...
           /*------addClass/removeClass categories-------*/
           $(".categories_links  > ul > li").on("click", function() {
               $(this).find('.my-link-area a').toggleClass('open').parent().parent().find('.my_categories_mega_menu, my_categorie_sub').toggleClass('open');
               $(this).siblings().find('.my_categories_mega_menu, .my_categorie_sub').removeClass('open');
           });
   ...
   $(".categories_links  > ul > li.dropdown_list .my-link-area > a").on('click',function(){
           $(this).find('i').toggleClass('fa-plus').toggleClass('fa-minus');
   });
   
   $(".categories_links  > ul > li.dropdown_list .my-link-area > a").each(function(){
       $(this).html('<i class="fas fa-plus"></i>');
   });
...
// // new by das---categories mobile responsive
...
if($(window).width()>500){
    ...
    $(window).on('scroll', function () {
        ...
        if ($window.scrollTop( ) > 300 ) {
            ...
            $(".categories_menu").removeClass('display-none');
            
        } else {
           
            $(".categories_menu").addClass('display-none');
        }
    
       
    });

    $(".categories_links").removeClass('display-none');

}else{
    $(".categories_menu").removeClass('display-none');
    $(".categories_links").addClass('display-none');
...
$mainSlider.on('changed.owl.carousel', function(event) {
    ...
    var $trending_campaign_slider = $('.trending-campaign-slider');
    $trending_campaign_slider.owlCarousel({
        items: 2,
        autoplay: true,
        margin: 2,
        loop: true,
