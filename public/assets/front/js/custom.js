$(function ($) {
  ...
  $(document).ready(function () {
      ...
      $.get($(this).data('href'), function (data) {
       // console.log(data);
        ...
        if (data == 'digital') {
          ...
          toastr.error("Can not shop from two or more store at the same time");

        }
        else if (data == 3) {
         
          toastr.error("Can not add this product");
    ...
    $(document).on("click", "#qaddcrt", function () {
      ...
      window.location = mainurl + "/addtobuynowcart?id=" + pid + "&qty=" + qty + "&size=" + sizes + "&color=" + colors.substring(1, colors.length) + "&size_qty=" + size_qty + "&size_price=" + size_price + "&size_key=" + size_key + "&keys=" + keys + "&values=" + values + "&prices=" + prices;
    ...
    $('#division').on("change", function () {
      ...
      if (divisionID != "") {
        ...
        $.ajax({
          type: "GET",
          url: mainurl + "/districts/" + divisionID,
          success: function (data) {
    ...
    $('#district').on("change", function () {
      ...
      if (districtID != "") {
        ...
        $.ajax({
          type: "GET",
          url: mainurl + "/upazilas/" + districtID,
          success: function (data) {
            //   console.log(data);
            $('#upazila').html("");
