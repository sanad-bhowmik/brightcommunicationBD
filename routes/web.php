...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        //Customer Registration Bonus

        Route::get('/users/registration/bonus', 'Admin\UserController@bonusshow')->name('admin-bonus');

        //Customer Registration Bonus End
        ...
        Route::get('/user/withdraws/balance/reject/{id}', 'Admin\UserController@balanceReject')->name('admin-withdraw-balanceReject');
...
Route::prefix('user')->group(function () {
    ...
    // user balance withdraw request
    Route::get('/referral/code', 'User\WithdrawController@referralCode')->name('user-referral-code');
    Route::get('/balance/withdraw', 'User\WithdrawController@balanceIndex')->name('user-bw-index');
    Route::get('/balance/withdraw/create', 'User\WithdrawController@balanceCreate')->name('user-bw-create');
    Route::post('/balance/withdraw/create', 'User\WithdrawController@balanceStore')->name('user-bw-store');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    // Brand SECTION
    Route::get('/brand/{brand?}', 'Front\CatalogController@brand')->name('front.brand');
    // CATEGORY SECTION
    ...
    Route::get('/carts/referralcode/check', 'Front\CartController@referralCodeCheck');
    // CART SECTION ENDS
